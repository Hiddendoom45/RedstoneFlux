local gen_item = util.table.deepcopy(data.raw.item["rflux-burner-generator"])
local gen_rec = util.table.deepcopy(data.raw.recipe["rflux-burner-generator"])
local gen_ent = util.table.deepcopy(data.raw["burner-generator"]["rflux-burner-generator"])

gen_item.name = "rflux-survivalist-generator"
gen_item.order = "f[rflux]-[energy]-aa"
gen_item.place_result = "rflux-survivalist-generator"

gen_rec.name = "rflux-survivalist-generator"
gen_rec.order = "f[rflux]-[energy]-aa"
gen_rec.ingredients = {{"stone-brick",10}, {"rflux-redstone",2}}
gen_rec.result = "rflux-survivalist-generator"

gen_ent.name = "rflux-survivalist-generator"
gen_ent.minable.result = "rflux-survivalist-generator"
gen_ent.order = "f[rflux]-[energy]-aa"
gen_ent.burner.effectivity = 2
gen_ent.max_power_output = "200kW"
gen_ent.energy_source.usage_priority = "primary-output"
...
--     {
--         type = "item",
--         name = "rflux-survivalist-generator",
--         icon = "__redstone-flux__/graphics/icons/redstone-burner-generator.png",
--         icon_size = 64, icon_mipmaps = 4,
--         subgroup = "energy",
--         order = "f[rflux]-[energy]-aa",
--         place_result = "rflux-survivalist-generator",
--         stack_size = 50
--     },
--     {
--         type = "recipe",
--         name = "rflux-survivalist-generator",
--         ingredients = {{"stone-brick",10}, {"rflux-redstone",2}},
--         result = "rflux-survivalist-generator",
--         energy_required = 5,
--         enabled = false,
--         order = "f[rflux]-[energy]-aa",
